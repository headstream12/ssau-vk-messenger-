...
typedef enum {
    BxTopResizingNone = 0,
    BxTopResizingLeft = 1 << 0,
    BxTopResizingRight = 1 << 1
} BxTopResizing;
...
//! default is BxNone
@property (nonatomic) BxTopResizing topResizing;
 ...
 */
@property (nonatomic) BOOL shouldAllowPanningPastAnchor;
...
/** Specifies if the top view snapshot requires a pan gesture recognizer.
 ...
 By default, this is set to NO
 */
@property (nonatomic) BOOL shouldAddPanGestureRecognizerToTopViewSnapshot;

/** Specifies the behavior for the under left width
 
 By default, this is set to ECFullWidth
 */
@property (nonatomic) ECViewWidthLayout underLeftWidthLayout;

/** Specifies the behavior for the under right width
 
 By default, this is set to ECFullWidth
 */
@property (nonatomic) ECViewWidthLayout underRightWidthLayout;
 ...
 */
@property (nonatomic) ECResetStrategy resetStrategy;
