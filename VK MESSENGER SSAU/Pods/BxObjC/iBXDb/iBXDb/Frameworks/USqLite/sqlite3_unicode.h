...
*/
SQLITE_EXPORT u16 bx_unicode_sqlite3_unicode_fold(u16 c);
SQLITE_EXPORT u16 bx_unicode_sqlite3_unicode_lower(u16 c);
SQLITE_EXPORT u16 bx_unicode_sqlite3_unicode_upper(u16 c);
SQLITE_EXPORT u16 bx_unicode_sqlite3_unicode_title(u16 c);
...
*/
SQLITE_EXPORT u16 bx_unicode_sqlite3_unicode_unacc(u16 c, u16 **p, int *l);
...
*/
SQLITE_EXPORT int bx_unicode_sqlite3_unicode_collate(
  void *encoding,
